...
if __name__ == '__main__':
    ...
    if choice == 1:
        ...
        lib.pod_wallpaper_changer.change_wp(
            wp_pod, saveDirAPoD, SHOW_DEBUG, date)

    elif choice == 2:
        lib.unsplash_wallpaper_changer.change_wp(
            wp_unsplash, saveDirUnsplash, SHOW_DEBUG)

    elif choice == 3:
        lib.natgeopod_wallpaper_changer.change_wp(
            wp_natgeo_pod, saveDirNatGeoPoD, SHOW_DEBUG)

    elif choice == 4:
        lib.desktoppr_wallpaper_changer.change_wp(
